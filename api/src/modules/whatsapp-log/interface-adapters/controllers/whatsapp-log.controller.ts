...
import type { GetWhatsappLogsSummaryUseCase } from "../../application/use-cases/get-whatsapp-logs-summary.use-case.js";
...
export class WhatsappLogController {
  ...
  getSummary = async (req: Request, res: Response) => {
    ...
    try {
      const result = await this.getWhatsappLogsSummaryUseCase.execute(parsed.data);
      res
        .status(200)
