...
class UserDeviceRemoteDataSource {
  ...
  UserDeviceRemoteDataSource(this.dio);
...
final userDeviceRemoteDataSourceProvider = Provider<UserDeviceRemoteDataSource>((ref) {
  return UserDeviceRemoteDataSource(ref.read(dioProvider));
});
